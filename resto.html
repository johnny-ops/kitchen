...
<div class="loader_bg">
    ...
    <header>
    <a href="" class="logo"><i class="fa-solid fa-utensils"></i>Mikaela's Kitchen</a>
    ...
    <section class="home" id="home">
        ...
        <div class="wrapper">
            ...
            <span class="title-word title-word-3">Michaela's</span>
            <span class="title-word title-word-4">Kitchen</span>
          </h2>
            </div>
                <div class="image">
        ...
        <form action="">
            <div class="inputbox">
                ...
                <div class="input">
                    ...
                    <input type="test" placeholder="additional food">
                </div>
                <div class="input">
                    <span>How much</span>
            ...
            <input type="submit" value="order now" onclick="alert('Ordered Submited!')" class="btn">
        </form>
    </section>
